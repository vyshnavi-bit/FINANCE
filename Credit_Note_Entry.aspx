<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Credit_Note_Entry.aspx.cs" Inherits="Sample_credit_entry" %>
...
//            var data = document.getElementById('fin_yr');
//            var length = data.options.length;
//            document.getElementById('fin_yr').options.length = null;
...
//            }
        ...
        function VoucherTypechange() {
            var transactiontype = document.getElementById('txt_vou').value;
        ...
        function save_credit_note()
        {
            ...
            var deb_acc = document.getElementById('txt_head').value;
            if (deb_acc == "") {
            ...
            var cre_acc = document.getElementById('txt_sub_head').value;
            if (cre_acc == "") {
            ...
            var data = { 'op': 'save_credit_entry_details', 'sno': sno, 'trans_dt': trans_dt, 'fin_yr': fin_yr, 'gl_code': gl_code, 'party_tp': party_tp, 'party_cd': party_cd, 'inv_no': inv_no, 'inv_dt': inv_dt, 'inv_amt': inv_amt, 'vou_tp': vou_tp, 'deb_acc': deb_acc, 'deb_amt': deb_amt, 'cre_acc': cre_acc, 'cre_amt': cre_amt, 'remarks': remarks, 'btn_save': btn_save };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        alert(msg);
        ...
        {
            var data = { 'op': 'get_credit_entry_details' };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
        ...
        function fill_credit_details(msg) {
            ...
            results += '<thead><tr><th scope="col"></th><th scope="col">Transaction Date</th><th scope="col">Financial Year</th><th scope="col">Group Ledger</th><th scope="col">Party Type</th><th scope="col">Party Name</th><th scope="col">Invoice No</th><th scope="col">Invoice Date</th><th scope="col">Invoice Amount</th><th scope="col">Voucher Type</th><th scope="col">Debit Account</th><th scope="col">Debit Amount</th><th scope="col">Credit Account</th><th scope="col">Credit Amount</th><th scope="col">Remarks</th></tr></thead></tbody>';
            for (var i = 0; i < msg.length; i++) {
                ...
                results += '<td style="display:none;" data-title="Party Name" class="2">' + msg[i].party_cd + '</td>';
                results += '<td style="display:none;" data-title="Party Code" class="20">' + msg[i].party_cd1 + '</td>';
                results += '<td data-title="Party Name" class="24">' + msg[i].party_name + '</td>';
        ...
        function update(thisid) {
            ...
            document.getElementById('txt_vou').value = vou_tp;
        ...
        function clear_credit_note()
        {
            ...
            document.getElementById('txt_vou').value = "";
            document.getElementById('txt_vou_sno').value = "";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <section class="content-header">
        <h1>
            Credit Note Entry<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Credit Note Details
                </h3>
            </div>
            <div class="box-body">
                <div id="div_Payment">
                    ...
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td style="height: 40px;">
                                ...
                                <input id="slct_grp_ldgr" class="form-control" type="text" onchange="return get_primary_group()" placeholder="Enter Group Ledger"/>
                        ...
                        <tr>
                            ...
                            <td style="height: 40px;">
                                ...
                                <input id="slct_party_tp" class="form-control" type="text"  onchange="return get_party_details()" placeholder="Enter party type"/>
                        ...
                        <tr>
                            ...
                            <td style="height: 40px;">
                                <input id="slct_party_name" class="form-control" type="text" onchange="return get_party_code_det()" placeholder="Enter  Party Name"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td style="height: 40px;">
                                <input id="txt_inv_no" class="form-control" type="text" placeholder="Enter Invoice Number"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td style="height: 40px;">
                                ...
                                <input id="txt_vou" class="form-control" type="text" onchange="return get_trans_details()" placeholder="Enter Voucher Type"/>
                        ...
                        <tr>
                            ...
                            <td style="height: 40px;">
                                <input id="txt_deb_vou" type="text" class="form-control" placeholder="Enter Debit account"  onchange="return get_headofaccount_details()" />
                            ...
                            <%--<td>
                                <input id="btn_add_deb" type="button" onclick="BtnAddClick();" class="btn btn-success"
                                    name="Add" value='Add' />
                            </td>--%>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="height: 40px;">
                                <input id="txt_cre_vou" type="text" class="form-control" placeholder="Enter credit account"  onchange="return get_headofaccount_details()" />
                            ...
                            <%--<td>
                                <input id="btn_add_cre" type="button" onclick="Btn_subAddClick();" class="btn btn-success"
                                    name="Add" value='Add' />
                            </td>--%>
                        </tr>
                        <tr>
