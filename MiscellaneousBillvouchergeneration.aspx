...
CodeFile="MiscellaneousBillvouchergeneration.aspx.cs" Inherits="MiscellaneousBillvouchergeneration" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                     Miscellaneous Bill voucher generation<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#"> Miscellaneous Bill voucher generation </a></li>
                </ol>
            </section>
                                ...
                                <td>
                                    <div>
                                        <table id="tbltrip">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblrefno" runat="server">Refrence No:</asp:Label>
                                                </td>
                                                <td>
                    ...
                    <div style="width: 100%;">
                        ...
                        <div style="width: 100%;">
                            <span style="font-size: 18px; font-weight: bold; padding-left: 37%; text-decoration: underline;
                                color: #0252aa;"> Miscellaneous Bill voucher </span>
                            <div>
                            </div>
                        </div>
                    </div>
                    <div style="float: right;">
                                <div style="width: 100%;">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="width: 28%; padding-left: 10%;">
                                                <span style="font-weight: bold;">Nature of Work : </span>
                                                <asp:Label ID="txtnatureofwork" runat="server" ForeColor="Red" Text=""></asp:Label>
                                            </td>
                                            <td style="width: 28%; padding-left: 10%;">
                                                <span style="font-weight: bold;">Nature of Work Description:</span>
                                                <asp:Label ID="txtnaturedescription" runat="server" ForeColor="Red" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 28%; padding-left: 10%;">
                                        ...
                                        <tr>
                                            <td style="width: 28%; padding-left: 10%;">
                                                <span style="font-weight: bold;">Advance Request No : </span>
                                                <asp:Label ID="txtadvreqno" runat="server" ForeColor="Red" Text=""></asp:Label>
                                            </td>
                                            <td style="width: 28%; padding-left: 10%;">
                                                <span style="font-weight: bold;">Advance Request Date : </span>
                                                <asp:Label ID="txtadvreqdate" runat="server" ForeColor="Red" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 28%; padding-left: 10%;">
                                            ...
                                            <td style="width: 28%; padding-left: 10%;">
                                                <span style="font-weight: bold;">Department Name : </span>
                                                <asp:Label ID="txtdepartmentcode" runat="server" ForeColor="Red" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 28%; padding-left: 10%;">
                                                <span style="font-weight: bold;">Particulars : </span>
                                                <asp:Label ID="txtparticulers" runat="server" ForeColor="Red" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 28%; padding-left: 10%;">
                                                <span style="font-weight: bold;">Total Amount : </span>
                                                <asp:Label ID="txttotalammount" runat="server" ForeColor="Red" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 28%; padding-left: 10%;">
