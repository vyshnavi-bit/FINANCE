<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DepreciationStatementReport.aspx.cs" Inherits="DepreciationStatementReport" %>
...
<div>
    ...
    <section class="content-header">
        <h1>
             DepreciationStatement Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#"> DepreciationStatement Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i> DepreciationStatement  Details
                </h3>
            </div>
            <div class="box-body">
                    ...
                    <div style="width: 100%;">
                        ...
                        <div style="width: 100%;">
                            <span style="font-size: 18px; font-weight: bold; padding-left: 37%; text-decoration: underline;
                                color: #0252aa;"> DepreciationStatement  Report</span>
                            <div>
                            </div>
                        </div>
                    </div>
