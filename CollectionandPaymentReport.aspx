<%@ Page Title=""  EnableEventValidation="false" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CollectionandPaymentReport.aspx.cs" Inherits="CollectionandPaymentReport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    CollectionandPayment Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">CollectionandPayment Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>CollectionandPayment eDetails
                        </h3>
                            ...
                            <table>
                                <tr>
                                    <td style="width: 350PX;">
                                        ...
                                        <asp:ListItem Text="Collections" Value="Collections">Collections</asp:ListItem>
                                            <asp:ListItem Text="Payments" Value="Payments">Payments</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">
                                             CollectionandPaymentReport</span><br />
                                        </div>
                                        ...
                                        <%--<div>
                                           <asp:GridView ID="grdview1"  runat="server" ForeColor="White" Width="100%" CssClass="gridclss1"
                                               GridLines="Both" Font-Bold="true"">
                                              <Columns>
                                               <asp:BoundField DataField="Name" HeaderText="Name" ItemStyle-Width="150" />
                                               <asp:BoundField DataField="Accountno" HeaderText="Accountno" ItemStyle-Width="150" />
                                               <asp:BoundField DataField="HeadofAccountName" HeaderText="HeadofAccountName" ItemStyle-Width="150" />
