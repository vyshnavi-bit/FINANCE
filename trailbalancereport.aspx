...
CodeFile="trailbalancereport.aspx.cs" Inherits="trailbalancereport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div>
    ...
    <section class="content-header">
        <h1>
             Trial Balance Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#"> Trial Balance Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i> Trial Balance Details
                </h3>
            </div>
            <div class="box-body">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddldebitcradit" runat="server" CssClass="form-control">
                    ...
                    <td>
                      <asp:DropDownList ID="ddlfinanialyear" runat="server" CssClass="form-control">
                         </asp:DropDownList>
                        </td>
                        <td style="width:5px;">
                    </td>
                    ...
                    <div style="width: 100%;">
                        <div style="width: 11%; float: left;">
                            ...
                            <span style="font-size: 18px; font-weight: bold; padding-left: 37%; text-decoration: underline;
                                color: #0252aa;"> Trail Balance Report</span>
                            <div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="width: 49%; float: left;">
                            <asp:GridView ID="grdpayments" runat="server" ForeColor="White" Width="100%" GridLines="Both"
                                ...
                                <div style=" padding-right: 45px;">
                                 <span style="font-weight: bold; font-size: 16px;">Difference Balance :</span><asp:Label ID="lblclosingbal" runat="server" ForeColor="Red" Font-Bold="true" Font-Size="18px" Text=""></asp:Label> 
