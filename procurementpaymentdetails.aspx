<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="procurementpaymentdetails.aspx.cs" Inherits="procurementpaymentdetails" %>
                                ...
                                <td>
                                    ...
                                    <label>Plant Name</label>
                                        <asp:Panel ID="Panel2" runat="server">
                                            <asp:DropDownList ID="ddl_Plantname" runat="server" CssClass="form-control" AutoPostBack="True" onselectedindexchanged="ddl_Plantname_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </asp:Panel>
                                    </td>
                                </td>
                                ...
                                <td>
                                    ...
                                    <label>Bill Date</label>
                                        <asp:Panel ID="Panel1" runat="server">
                                            <asp:DropDownList ID="ddl_BillDate" runat="server" CssClass="form-control" AutoPostBack="True" onselectedindexchanged="ddl_BillDate_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </asp:Panel>
                                    </td>
                                </td>
                                ...
                                <td>
                                    ...
                                    <label>File Name</label>
                                        <asp:Panel ID="Panel3" runat="server">
                                            <asp:DropDownList ID="ddlfilename" runat="server" CssClass="form-control" >
                                            </asp:DropDownList>
                                        </asp:Panel>
                                    </td>
                                </td>
