...
public partial class procurementpaymentdetails : System.Web.UI.Page
{
    SqlCommand cmd;
    string BranchID = "";
                ...
                foreach (DataRow dr in dtfiles.Rows)
                {
                    ...
                    foreach (DataRow dra in report.Select("BankFileName='" + dr["BankFileName"].ToString() + "'"))
                    {
                        ...
                        if (vdate != "")
                        {
                            ...
                            mnth = dtvocherdate.ToString("MM");
                            cyear = dtvocherdate.ToString("yyyy");
                        }
                        ...
                        newrow["JV No"] = "BANK_PAY" + "" + bankfilename;
                        jvnumber = "BANK_PAY" + "" + bankfilename;
