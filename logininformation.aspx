<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="logininformation.aspx.cs" Inherits="logininformation" %>
...
<script type="text/javascript">
    ...
    function get_employee_details() {
        var data = { 'op': 'get_employee_detail_login' };
        var s = function (msg) {
            if (msg) {
                employeenames = msg;
                var availableTags = [];
