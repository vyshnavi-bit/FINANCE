<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SubReceiptsReport.aspx.cs" Inherits="SubReceiptsReport" %>
...
<div>
    ...
    <section class="content-header">
        <h1>
            Sub Receipts<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>SAP Reports</a></li>
            <li><a href="#">Sub Receipts</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Sub Receipts Details
                </h3>
            </div>
            <div class="box-body">
