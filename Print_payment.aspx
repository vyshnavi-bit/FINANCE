<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Print_payment.aspx.cs" Inherits="Print_payment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function PopupOpen(VocherID) {
            var data = { 'op': 'GetSubPaybleValues', 'VoucherID': VocherID };
            var s = function (msg) {
                if (msg) {
                                    ...
                                    <td>
                                        <div>
                                            <table id="tbltrip">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lbl_tripid" runat="server">Payment No:</asp:Label>
                                                    </td>
                                                    <td>
