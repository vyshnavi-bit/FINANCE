<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TallyReceipts.aspx.cs" Inherits="TallyReceipts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Tally Reports</a></li>
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Tally Receipts</span>
                                        </div>
                                        <div align="center">
